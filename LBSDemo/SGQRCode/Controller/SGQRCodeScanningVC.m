...
@interface SGQRCodeScanningVC () <AVCaptureMetadataOutputObjectsDelegate>
/// 会话对象
...
- (void)viewDidLoad {
    ...
    [button setFrame:CGRectMake(0, 64, 100, 60)];
...
- (void)setupNavigationBar {
    ...
    self.cusTopBar.frame = CGRectMake(0, 0, self.view.frame.size.width, QRNavbarHeight);
    
    NSLog(@"%@", self.cusTopBar);
    [self.cusTopBar setBackgroundColor:[UIColor whiteColor]];
    ...
    [imagev setImage:[UIImage imageNamed:@"SGQRCode.bundle/back"]];
